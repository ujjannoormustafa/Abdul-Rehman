      ...
      <div className=" py-8  items-center justify-center md:flex lg:hidden ">
        ...
        <div className="topline flex justify-evenly w-full py-4 " >
          <div className="w-2/5 hidden items-center justify-start md:hidden lg:flex ">
            <div className="text-7xl font-bold">Let's Talk</div>
          </div>
...
<button
  class="overflow-hidden  relative font-semibold w-32 p-2 h-12 bg-black text-white border-none rounded-md text-xl font-bold cursor-pointer relative z-10 group"
>
 Visit My
  <span
